export const gamerules =[
  {
    ...
    "rules": [
      "Each set would be a best of 3 games of 11 points each",
  ...
  },
  {
    "gameName": "Chess",
    "rules": [
      "For rules, please refer https://en.wikipedia.org/wiki/Rules_of_chess",
    ...
    "rules": [
      {
        ...
        "subRules": [
          ...
          "The pair winning the toss shall have the option as above.",
